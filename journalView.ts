...
export class JournalView extends baseView.BaseView {
    ...
    create(): void {
        ...
        this.rootNode = this.provider.getJournalTree();
                    ...
                    self.contents("li").first()
                        .on("click", ".toggle", function () {
                            ...
                            if (self.data.type == 'manifest') {
                                $.publish(JournalView.VIEW_MANIFEST, [self.data.ref]);
                            } else {
                                $.publish(JournalView.VIEW_STRUCTURE, [self.data.ref]);
                            }
                        })
                },
